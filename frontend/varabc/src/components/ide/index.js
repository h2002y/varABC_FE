...
// firebaseConfig의 값들은 비공개로 올립니다.
const firebaseConfig = {
  apiKey: "API키",
  authDomain: "파이어베이스 domain",
  databaseURL:
    "파이어베이스 DB url",
  projectId: "파이어베이스 프로젝트 id",
  storageBucket: "파이어베이스 storage bucket",
  messagingSenderId: "파이어베이스 messaging sender id",
  appId: "파이어베이스 app id",
  measurementId: "파이어베이스 measurement id",
};
